 ...
 return (
    <div className="md-lg-main2:w-[80%] md-lg-main12:w-[64%] md-lg-main-2:w-[66%] md-lg-main-1-2:w-[66%] md-lg-main1:w-[68%] md-lg-main-1:w-[72%] md-lg-main:w-[72%] lg-main:w-[77%] lg:w-[85%] md-lg:w-[88%] md:w-[90%] sm:w-[96%] mx-auto" ref={containerRef}>
      ...
      <div className="flex flex-col reset-on-top:flex-row-reverse reset-on-top:items-center reset-on-top:justify-between w-full">
        ...
        <div className="flex flex-col reset-on-top:flex-row reset-on-top:items-center reset-on-top:space-x-3 space-y-1 reset-on-top:space-y-0 bg-[#0f172a] bg-opacity-15 p-4 reset-on-top:bg-transparent reset-on-top:p-0 reset-on-top:shadow-none">
      ...
      <div className="flex flex-col reset-on-top:flex-row reset-on-top:items-center reset-on-top:space-x-3 space-y-2 reset-on-top:space-y-0 bg-[#0f172a] bg-opacity-15 p-4 reset-on-top:bg-transparent reset-on-top:p-0 reset-on-top:shadow-none">
        <label 
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-3 w-full mt-6 space-y-2 sm:space-y-0 bg-[#0f172a] bg-opacity-15 p-4 reset-on-top:bg-transparent reset-on-top:p-0 reset-on-top:shadow-none">
